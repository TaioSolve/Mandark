...
#
#     from Mandark import metadata
#
# However, when we do this, we also import `Mandark/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        ...
        # 'gui_scripts': [
        #     'Mandark_gui = Mandark.gui:entry_point'
        # ]
    }
)
